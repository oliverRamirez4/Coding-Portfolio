/*
Instantiates a Block in the shape of an S, with a unique rotateBlock method compared to the other subclasses of Block
*/
public class SBlock extends Block{

  //Constructor that calls upon Block's constructor, with the parameter 2 to initialize the correct blockType
  public SBlock(){
    super(2);
  }
